...
function showMosqueModal() {
    document.getElementById('mosqueModal').style.display = 'block';
}

function hideMosqueModal() {
    document.getElementById('mosqueModal').style.display = 'none';
}
